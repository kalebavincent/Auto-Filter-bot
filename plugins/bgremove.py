...
async def rmbg(bot, message):
  ...
  if replied.photo:
      ...
      with open(y, 'rb') as photo_file:
          await message.reply_photo(photo=photo_file, caption="Voici votre image sans arrière-plan", quote=True)
      await message.reply_document(document=y, quote=True)
