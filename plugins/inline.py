...
async def inline_search(bot, query):
    """Afficher les résultats de recherche pour la requête en ligne donnée"""

    if is_banned(query):
        await query.answer(results=[],
                           cache_time=0,
                           switch_pm_text="Vous êtes un utilisateur banni :(",
...
def get_reply_markup():
    buttons = [[
        InlineKeyboardButton('⚡️ ᴄʜᴀɴɴᴇʟ ᴜᴘᴅᴀᴛᴇs ⚡️', url=UPDATES_LINK),
